...
function SavedDestinations() {
    ...
    const { saved, countries, removeFromSaved } = useContext(Context)
    ...
    const trashIcon = hovered ?
        <svg className="trash" onClick={removeFromSaved} xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
